...
$languages = [
  'swe' => [
    'titleS1' => ' <strong> Du är speciell. </strong> FastSecurity, FS.1.0',
    ...
    'titleF' => 'FastSecurity',
    'titleF2' => 'Här är våra <br> funktioner för framtiden',
    'feature1' => 'Välj färg',
    'feature2' => 'Exteriör',
    'feature2' => 'Interiör',
    'titleS2' => 'Historia',
  ...
  'eng' => [
    'titleS1' => ' <strong> You are special. </strong> FastSecurity, FS.1.0',
    ...
    'titleF' => 'FastSecurity',
    'titleF2' => 'Here are our <br> features for the future',
