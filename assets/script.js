...
window.addEventListener('scroll', () => {
    ...
    let modernityOffset = moduleModernity.getBoundingClientRect().y;
    let modernityHeight = moduleModernity.getBoundingClientRect().height;

    if(arrowOffset >= modernityOffset && arrowOffset < modernityOffset + modernityHeight){
        activatorMenu.children[0].textContent = moduleModernity.dataset.div;
    }
